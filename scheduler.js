...
async function startRunner(payload){
	...
	let newRunnerService = await cattleRustler.createStackService(process.env.RANCHER_ENV_ID, process.env.RANCHER_STACK_ID, payload.serviceName, payload.labels, payload.environmentVars, process.env.RUNNER_IMAGE_ID)
